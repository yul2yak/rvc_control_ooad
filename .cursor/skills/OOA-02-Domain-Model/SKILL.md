...
**Use Case·SSD**와 **FR·NFR**을 근거로 **Domain Model**(개념 모델)을 작성한다. 임의로로 개념 추가 금지.
**입력(필수):** `docs/OOA/UseCases/UC-*.md` (없으면 중단)
**산출:** `docs/OOA/02-Domain-Model.md`
---
## Domain Model — 정의 · 목표 (OOAD)
| | 내용 |
|---|------|
| **정의** | 도메인의 **개념 클래스(conceptual class)**·**연관**·**속성**을 표현한 **도메인 어휘 사전**. UML classDiagram **표기**를
쓰지만, Class Diagram과 다르다. |
