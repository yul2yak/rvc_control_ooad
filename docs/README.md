...
flowchart TD
  ...
  SR --> UC[OOA-01 skill]
  UC --> UCs[docs/OOA/UseCases/UC-*.md]
  UCs --> DM[OOA-02 skill]
...
| OOA | `OOA-01-UseCases` | `UseCases/UC-*.md` | — |
