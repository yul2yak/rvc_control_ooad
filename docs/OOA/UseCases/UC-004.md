...
| 4 | System이 우측 전환 **가능** 여부를 판단한다. | FR-004, UR-001 |
| 5 | System이 우측으로 방향을 전환한다. | FR-004, UR-001 |
| 6 | System이 직진 전진하며 청소·물걸레를 재개한다. | FR-004, §0.4, UR-002 |
...
| 3 | System이 후진한다. | FR-004, §0.4 |
| 4 | System이 우측 전환 가능 여부를 판단한다 — **불가**. | FR-004, UR-001 |
| 5 | System이 좌측으로 방향을 전환한다. | FR-004, UR-001 |
| 6 | System이 직진 전진하며 청소·물걸레를 재개한다. | FR-004, §0.4, UR-002 |
...
| canTurnRight | canTurnRight | — | FR-004, UR-001 |
...
| stopCleaning | stopCleaning | — | FR-004, §0.4 |
| moveBackward | moveBackward | — | FR-004, §0.4 |
| canTurnRight | canTurnRight | result=notFeasible | FR-004, UR-001 |
